...
class LaxWendroffScheme(BaseScheme):
    ...
    def compute_flux(
        ...
        """Compute Lax-Wendroff numerical flux.

        Uses the Richtmyer two-step version:
        1. Predictor: Lax-Friedrichs at half time step
        2. Corrector: Leapfrog using predicted values
        ...
        for i in range(nx + 1):
            ...
            # Predictor step (Lax-Friedrichs at interface)
            ...
            # Lax-Wendroff flux (Richtmyer version)
